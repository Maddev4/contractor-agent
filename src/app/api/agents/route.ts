...
export async function POST(request: Request) {
    try {
        ...
        const llmBody = {
            ...
            general_tools: [
                ...
                },
                {
                    type: "custom",
                    name: "log_data",
                    description: "Send all collected information to n8n. Extract following data from transcript.\n- responses: Name, Email, Phone\n- property: Type, Scope, Material\n- budget\n- timeline\n- followUp\n- summary",
                        ...
                        "properties": {
                          "property": {
                            ...
                            "properties": {
                              "type": {
                                "type": "string",
                                "description": "Property type like Primary residence, a Rental and Another property"
                              },
                              "material": {
                                "type": "string",
                                "description": "Property Material looks like clean, modern, durable, low-maintenance, etc."
                              },
                              "scope": {
                                "type": "string",
                                "description": "Property Scope like square footage, and number of linear feet"
                              }
                            }
                          },
                          "summary": {
        ...
        console.info("Agent Fully Created: ", {
